...
<div class="site-container flex-container">
    ...
    <aside class="filter-column">
        ...
        <div class="filter-column-top">
            ...
            ?>
            <span class="number"><?= $eventsNumber ?> workshops</span>
        </div>

        <h1 class="filter-title">Filter workshops</h1>
    ...
    <section class="my-events-grid main-grid">
        ...
        <?= Html::a('Add workshop', ['event/create', 'trainer_id' => $model->id], ['class' => 'btn btn-smaller btn-add btn-add-event']); ?>
